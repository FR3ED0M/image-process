...
class openImage:
    def openPlains(self):
        image = Image.open("plains.jpg")        # opens an image from database
        image.save('new_image.png')             # saves the image under a new name and datatype
...
def grayscale():
    im3 = Image.open("new_image.png").convert('L')     # open and convert image to grayscale
